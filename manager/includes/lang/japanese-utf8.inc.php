...
$_lang["credits_shouts_msg"] = '<p>MODX is managed and maintained at <a href="http://modx.com/company/" target="_blank">modx.com</a>.</p>';
...
$_lang["rb_base_url_message"] = 'ファイルブラウザディレクトリ(通常はcontentディレクトリ)のパスです。「ファイルブラウザディレクトリの物理パス」が参照する場所と同じですが、ここではMODX設置ディレクトリを基準とした相対パスを記述します。';
...
$_lang["uploadable_flash_message"] = 'ファイルブラウザを使用して「content/flash/ 」にアップロードできるフラッシュファイルの拡張子を入力してください。カンマで区切って複数入力できます。';
$_lang["uploadable_flash_title"] = 'アップロード可能なフラッシュ';
$_lang["uploadable_images_message"] = 'ファイルブラウザを使用して「content/images/ 」にアップロードできる画像ファイルの拡張子を入力してください。カンマで区切って複数入力できます。';
$_lang["uploadable_images_title"] = 'アップロード可能な画像タイプ';
$_lang["uploadable_media_message"] = 'ファイルブラウザを使用して「content/media/ 」にアップロードできるメディアファイルの拡張子を入力してください。カンマで区切って複数入力できます。';
...
$_lang["settings_friendlyurls_alert2"] = '.htaccessの内容を変更する必要があります。(参考 : sample.htaccess)';
